<?php
$ENABLE_ADD     = has_permission('Pricelist_fabric.Add');
$ENABLE_MANAGE  = has_permission('Pricelist_fabric.Manage');
$ENABLE_VIEW    = has_permission('Pricelist_fabric.View');
$ENABLE_DELETE  = has_permission('Pricelist_fabric.Delete');
?>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    //--------------------------------------------------------------------------------------------
    $(document).on('click', '.view_produk', function(e) {
      var id = $('#nm_item').val();
      $("#head_title").html("<b>EDIT FORM</b>");
      $("#view2").load(siteurl + active_controller + 'modal_view/' + id);
      $("#view_produk").modal();
    });

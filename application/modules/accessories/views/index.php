...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_accessories');
	  // alert(id);
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>EDIT ACCESSORIES</b>");
...
//--------------------------------------------------------------------------------------------
    ...
    $(document).on('click', '.delete', function(e){
      var id_accessories = $(this).data('id_accessories');
      swal({
        title: "Are you sure?",
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
            ...
            dataType : "json",
            type: 'POST',
            data: {id_accessories:id_accessories},
    ...
    jQuery(document).on('click', '#saveAccessories', function(){
      var valid = getValidation();
      // console.log(valid);
      if (valid) {
        var formdata = new FormData(document.getElementById("form-accessories"));//$("#form-supplier").serialize();
        // console.log(formdata);
        $.ajax({
          url: siteurl+active_controller+"saveDataAccessories",
          dataType : "json",
          type: 'POST',
          data: formdata,
          processData:false,
  ...
  function add_data(){
    $(".modal-dialog").css('width','60%');
    $("#head_title").html("<b>Add Accessories</b>");

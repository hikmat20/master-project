            ...
            <tbody>
              ...
              <tr id="my-grid-tr-name_pattern_type">
                ...
                <td class="text-left">
                  ...
                  <label class="label_input">
                  <?php
                  echo form_input(array('type'=>'text','id'=>'name_pattern_type','name'=>'name_pattern_type','class'=>'form-control input-sm required w60', 'placeholder'=>'Collection Name','autocomplete'=>'off','value'=>empty($getC->name_pattern_type)?'':$getC->name_pattern_type))
                  ?>

<?php
    $ENABLE_ADD     = has_permission('Accessories_cost.Add');
    $ENABLE_MANAGE  = has_permission('Accessories_cost.Manage');
    $ENABLE_VIEW    = has_permission('Accessories_cost.View');
    $ENABLE_DELETE  = has_permission('Accessories_cost.Delete');
?>
...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="accessories_cost">
              ...
              <div class="box-body">
                ...
                <table id="tableset" class="table table-bordered table-striped">
                  <thead>
                    <tr>
						<th width="5">#</th>
						<th width="10%">ID Accessories</th>
						<th width="15%">Itme Name</th>
						<th width="10%">Category</th>
						<th>Calculation</th>
						<th width="7%" class="text-center">Rate(%)</th>
						<th width="10%" class="text-center">Rate(Rp.)</th>
...
//--------------------------------------------------------------------------------------------
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_accessories_cost');
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>EDIT FOH COST</b>");
      $("#view").load(siteurl+active_controller+'/modal_Process/Accessories_cost/edit/'+id);
      $("#ModalView").modal();
		});
    ...
    $(document).on('click', '.detail', function(e){
      ...
      $("#view").load(siteurl+active_controller+'modal_Process/Accessories_cost/view/'+id);
      $("#ModalView").modal();
		});

    //DELETE
    $(document).on('click', '.delete', function(e){
      var id_accessories_cost = $(this).data('id_accessories_cost');
      swal({
        title: "Are you sure?",
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
            ...
            dataType : "json",
            type: 'POST',
            data: {id_accessories_cost:id_accessories_cost},
    ...
    jQuery(document).on('click', '#addSave', function(){
      ...
      if (valid) {
        ...
        $.ajax({
          url: siteurl+active_controller+"saveAccessoriesCost",
          dataType : "json",
          type: 'POST',
          data: formdata,
          processData:false,
  ...
  function add_data(){
    ...
    $("#view").load(siteurl+active_controller+'/modal_Process/Accessories_cost/add/');
    $("#ModalView").modal();
  }

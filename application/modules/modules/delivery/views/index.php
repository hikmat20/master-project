...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_delivery');
	  location.href = siteurl+active_controller+'editDelivery/'+id;
      // $(".modal-dialog").css('width','60%');
      // $("#head_title").html("<b>EDIT DELIVERY COST</b>");
    ...
    $(document).on('click', '.detail', function(e){
      ...
      $("#view").load(siteurl+active_controller+'modal_Process/Delivery/view/'+id);
      $("#ModalView").modal();
		});
//--------------------------------------------------------------------------------------------
  ...
  function add_data(){
	window.location.href = siteurl+active_controller+'addDelivery';
    // $(".modal-dialog").css('width','60%');
    // $("#head_title").html("<b>Add Delivery Cost</b>");
    // $("#view").load(siteurl+active_controller+'/modal_Process/Delivery/add/');
    // $("#ModalView").modal();
  }

<?php
    $ENABLE_ADD     = has_permission('Accomodation.Add');
    $ENABLE_MANAGE  = has_permission('Accomodation.Manage');
    $ENABLE_VIEW    = has_permission('Accomodation.View');
    $ENABLE_DELETE  = has_permission('Accomodation.Delete');
?>
    ...
    <div class="tab-content">
        ...
        <div class="tab-pane" id="Category">
          <div class="box box-primary">
              <div class="box-header">
                <div style="display:inline-block;width:100%;">
                  <a class="btn btn-sm btn-success" href="javascript:void(0)" title="Add" onclick="add_Category()" style="float:left;margin-right:8px"><i class="fa fa-plus">&nbsp;</i>New</a>
                 <!-- <a class="btn btn-sm btn-danger pdf" id="pdf-report" style="float:right;margin:8px 8px 0 0"><i class="fa fa-file"></i> PDF</a>
                  <a class="btn btn-sm btn-success excel" id="excel-report" style="float:right;margin:8px 8px 0 0"><i class="fa fa-table"></i> Excel</a>-->
                </div>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_accomodation');
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>EDIT ACCOMODATION</b>");
      $("#view").load(siteurl+active_controller+'/modal_Process/Accomodation/edit/'+id);
      $("#ModalView").modal();
		});
    ...
    $(document).on('click', '.edit_cat', function(e){
      ...
      $("#view").load(siteurl+active_controller+'/modal_Process/Category/edit/'+id);
      $("#ModalView").modal();
		});
    ...
    $(document).on('click', '.detail', function(e){
      ...
      $("#view").load(siteurl+active_controller+'modal_Process/Accomodation/view/'+id);
      $("#ModalView").modal();
		});
//--------------------------------------------------------------------------------------------
    ...
    $(document).on('click', '.delete', function(e){
      var id_accomodation = $(this).data('id_accomodation');
      swal({
        title: "Are you sure?",
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
            ...
            dataType : "json",
            type: 'POST',
            data: {id_accomodation:id_accomodation},
    ...
    jQuery(document).on('click', '#addSupplierSave', function(){
      ...
      if (valid) {
        ...
        $.ajax({
          url: siteurl+active_controller+"saveAccomodation",
          dataType : "json",
          type: 'POST',
          data: formdata,
          processData:false,
  ...
  function add_data(){
    $(".modal-dialog").css('width','60%');
    $("#head_title").html("<b>Add Accomodation</b>");
    $("#view").load(siteurl+active_controller+'/modal_Process/Accomodation/add/');
    $("#ModalView").modal();
  }
  ...
  function add_Category(){
    ...
    $("#view").load(siteurl+active_controller+'/modal_Process/Category/add/');
    $("#ModalView").modal();
  }

                ...
                <tbody>
                  ...
                  <tr id="my-grid-tr-start_date">
                    ...
                    <td class="text-left">
                      ...
                      <label class="label_input">
                        <?php
                        echo form_input(array('type' => 'text', 'id' => 'start_date', 'name' => 'start_date', 'class' => 'form-control input-sm required datepicker w30', 'placeholder' => 'Customer Start Date', 'autocomplete' => 'off', 'value' => empty($getC->start_date) ? date('Y-m-d') : $getC->start_date))
                        ?>
            ...
            <table id="my-grid2" class="table-condensed" width="100%">
              <tbody>
                ...
                <tr id="my-grid-tr-vat_name">
                  <td class="text-left vMid">NPWP Name</td>
                  <td class="text-left">
                    <label class="label_view">
                      <?= $getC->vat_name ?>
                    </label>
                  ...
                  <tr>
                    <td>
                      <div class="label_input">
                        <a class="text-red hapus_item_js" href="javascript:void(0)" title="Delete List"><i class="fa fa-times"></i></a> || <span class="numbering-pic"><?= $no ?></span>
                    ...
                    <td>
                      <div class="label_input">
                        <input type="text" name="pic_phone[]" class="form-control input-sm " required="" placeholder="Input PIC Number" value="<?= $vp->phone_pic ?>">
                      </div>
                      <div class="label_view">
                        <?= $vp->phone_pic ?>
                      </div>
                    ...
                    <td>
                      <div class="label_input">
                        <input type="text" name="pic_email[]" class="form-control input-sm " required="" placeholder="Input PIC Email" value="<?= $vp->email_pic ?>">
                      </div>
                      <div class="label_view">
                        <?= $vp->email_pic ?>
                      </div>
                    ...
                    <td>
                      <div class="label_input">
                        <input type="text" name="pic_position[]" class="form-control input-sm " required="" placeholder="Input PIC Position" value="<?= $vp->position_pic ?>">
                      </div>
                      <div class="label_view">
                        <?= $vp->position_pic ?>
                      </div>
                    ...
                    <td>
                      <div class="label_input">
                        <input type="text" name="pic_religion[]" class="form-control input-sm " required="" placeholder="Input PIC Religion" value="<?= $vp->religion_pic ?>">
                      </div>
                      <div class="label_view">
                        <?= $vp->eligion_pic ?>
                      </div>

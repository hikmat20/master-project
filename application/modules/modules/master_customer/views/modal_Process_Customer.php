                  ...
                  <tr id="my-grid-tr-telephone">
                    ...
                    <td class="text-left">
                      <label class="label_input">
                        ...
                        echo form_input(array('type' => 'text', 'id' => 'telephone', 'name' => 'telephone[]', 'class' => 'form-control required w60', 'placeholder' => 'Telephone', 'autocomplete' => 'off', 'maxlength' => '4', 'value' => empty($tlp[0]) ? '' : $tlp[0]));
                        // echo " - ";
                        // echo form_input(array('type' => 'text', 'id' => 'telephone', 'name' => 'telephone[]', 'class' => 'form-control numberOnly w40', 'placeholder' => 'Number', 'autocomplete' => 'off', 'maxlength' => '9', 'value' => empty($tlp[1]) ? '' : $tlp[1]));
                        ?>
                  ...
                  <tr id="my-grid-tr-telephone_2">
                    ...
                    <td class="text-left">
                      ...
                      <label class="label_input">
                        ...
                        echo form_input(array('type' => 'text', 'id' => 'telephone_2_1', 'name' => 'telephone_2[]', 'class' => 'form-control w60', 'placeholder' => 'Other Telephone', 'autocomplete' => 'off', 'value' => empty($tlp[0]) ? '' : $tlp[0]));
                        // echo " - ";
        ...
        <div class="col-md-12">
          <section id="PIC">
            <table width="100%" class="table-condensed">
              <tr style='background-color: #175477; color: white; font-size: 15px;'>
                <th class="text-center" colspan='2'>PIC <span class='text-red'>*</span></b></th>
              </tr>
            </table>
            <div class="row">
              <div class="col-md-6 data-pic">
                <br>
                <?php $no = 0;
                foreach ($getCP as $vp) : $no++; ?>
                  <div class="list-pic">
                    <button type="button" class="btn_hapus_pic btn btn-sm btn-danger">x</button>
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Name PIC</label>
                        <div class="col-sm-8">
                          <input type="text" name="pic_customer[<?= $no ?>][name_pic]" class="form-control" placeholder="PIC Name" value="<?= $vp->name_pic ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Telephone</label>
                        <div class="col-sm-8">
                          <input type="text" name="pic_customer[<?= $no ?>][pic_phone]" class="form-control" placeholder="Phone Number" value="<?= $vp->phone_pic ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Email</label>
                        <div class="col-sm-8">
                          <input type="text" name="pic_customer[<?= $no ?>][pic_email]" class="form-control" placeholder="Email" value="<?= $vp->email_pic ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Position</label>
                        <div class="col-sm-8">
                          <input type="email" name="pic_customer[<?= $no ?>][pic_position]" class="form-control" placeholder="Position" value="<?= $vp->position_pic ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Religion</label>
                        <div class="col-sm-8">
                          <select name="pic_customer[<?= $no ?>][pic_religion]" class="form-control select2-100" data-id="<?= $no ?>" id="religion_<?= $no ?>" placeholder="Religion">
                            <option value=""></option>
                            <?php
                            $rel = $this->db->get('religion')->result();
                            foreach ($rel as $religion) {
                            ?>
                              <option value="<?= $religion->id ?>" <?= $religion->id == $vp->religion_pic ? 'selected' : '' ?>><?= $religion->name_religion ?></option>
                            <?php
                            }
                            ?>
                          </select>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">NPWP PIC</label>
                        <div class="col-sm-8">
                          <input type="text" name="pic_customer[<?= $no ?>][npwp_pic]" class="form-control" placeholder="NPWP PIC" value="<?= $vp->npwp_pic ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Bank Account</label>
                        <div class="col-sm-8">
                          <input type="text" name="pic_customer[<?= $no ?>][bank_account]" class="form-control" placeholder="Bank Account" value="<?= $vp->bank_account ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Birthday</label>
                        <div class="col-sm-8">
                          <input type="date" name="pic_customer[<?= $no ?>][birthday]" class="form-control" placeholder="Birthday" value="<?= $vp->birthday ?>">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="form-horizontal" role="form">
                      <div class="form-group">
                        <label for="input" class="col-sm-3">Name Card</label>
                        <div class="col-sm-8">
                          <input type="file" name="pic_customer[<?= $no ?>][name_card]" class="form-control" placeholder="Name Card" value="<?= $vp->name_card ?>">
                        </div>
                      </div>
                    </div>
                  </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $('#addPIC').click(function(e) {
      var x = parseInt($("#list-pic").length) + 1;
      getReligion(x);
      //console.log(x);
      var row = '<div class="list-pic">' +
        '<button type="button" class="btn_hapus_pic btn btn-sm btn-danger">x</button>' +
        '<div class="form-horizontal" role="form">' +
        '<div class="form-group">' +
        '<label for="input" class="col-sm-3">Name PIC</label>' +
        '<div class="col-sm-8">' +
        '<input type="text" name="pic_customer[' + x + '][name_pic]" class="form-control" placeholder="PIC Name">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Telephone</label>' +
        '<div class="col-sm-8">' +
        '<input type="text" name="pic_customer[' + x + '][pic_phone]" class="form-control" placeholder="Phone Number">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Email</label>' +
        '<div class="col-sm-8">' +
        '<input type="text" name="pic_customer[' + x + '][pic_email]" class="form-control" placeholder="Email">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Position</label>' +
        '<div class="col-sm-8">' +
        '<input type="email" name="pic_customer[' + x + '][pic_position]" class="form-control" placeholder="Position">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Religion</label>' +
        '<div class="col-sm-8">' +
        '<select name="pic_customer[' + x + '][pic_religion]" class="form-control select2-100" placeholder="Religion">' +
        '<option value=""></option>' +
        <?php
        $rel = $this->db->get('religion')->result();
        foreach ($rel as $religion) {
        ...
        '<label for="input" class="col-sm-3">NPWP PIC</label>' +
        '<div class="col-sm-8">' +
        '<input type="text" name="pic_customer[' + x + '][npwp_pic]" class="form-control" placeholder="NPWP PIC">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Bank Account</label>' +
        '<div class="col-sm-8">' +
        '<input type="text" name="pic_customer[' + x + '][bank_account]" class="form-control" placeholder="Bank Account">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Birthday</label>' +
        '<div class="col-sm-8">' +
        '<input type="date" name="pic_customer[' + x + '][birthday]" class="form-control" placeholder="Birthday">' +
        '</div>' +
        '</div>' +
        '</div>' +
        ...
        '<label for="input" class="col-sm-3">Name Card</label>' +
        '<div class="col-sm-8">' +
        '<input type="file" name="pic_customer[' + x + '][name_card]" class="form-control" placeholder="Name Card">' +
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'
    ...
    //REMOVE LIST BUTTON
    $(document).on('click', '.btn_hapus_pic', function() {
      //console.log('a');
      $(this).parents('div.list-pic').remove();
    ...
    $(document).on('change blur', '#name_custosmer', function(e) {
  ...
  var x = parseInt($("#list-pic").length);
  if (x > 0) {
    for (let i = 0; i < x; i++) {
      e = parseInt(i) + 1;
      // alert(e);

<?php
$ENABLE_ADD     = has_permission('Mp_class.Add');
$ENABLE_MANAGE  = has_permission('Mp_class.Manage');
$ENABLE_VIEW    = has_permission('Mp_class.View');
$ENABLE_DELETE  = has_permission('Mp_class.Delete');
?>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit', function(e) {
      ...
      $("#view").load(siteurl + active_controller + '/modal_Process/Class/edit/' + id);
      $("#ModalView").modal();
    });
    ...
    $(document).on('click', '.detail', function(e) {
      ...
      $("#view").load(siteurl + active_controller + 'modal_Process/Class/view/' + id);
      $("#ModalView").modal();
    });
    ...
    jQuery(document).on('click', '#addClassSave', function() {
      ...
      if (valid) {
        ...
        $.ajax({
          url: siteurl + active_controller + "saveClass",
          dataType: "json",
          type: 'POST',
          data: formdata,
          success: function(result) {
  ...
  function add_data() {
    $(".modal-dialog").css('width', '55%');
    $("#head_title").html("<b>Add Class</b>");
    $("#view").load(siteurl + active_controller + '/modal_Process/Class/add/');
    $("#ModalView").modal();
  }
</script>
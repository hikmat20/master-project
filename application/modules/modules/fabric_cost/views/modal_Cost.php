...
if (!empty($this->uri->segment(3))) {
  ...
  $getC = $this->db->get_where('fabric_cost',array('id_fabric_cost'=>$id))->row();
        ...
        <table id="my-grid3" class="table table-striped table-bordered table-hover table-condensed" width="100%">
          <tbody>
            <tr style='background-color: #175477 !important; color: white; font-size: 15px !important;'>
              <th class="text-center" colspan='3'>DETAIL FABRIC COST</th>
            </tr>
            <tr id="my-grid-tr-id_fabric_cost">
              <td class="text-left vMid" width="20%">Code <span class='text-red'>*</span></b></td>
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$getC->id_fabric_cost:'-'?>
                </label>
                <label class="label_input">
                  <input type="hidden" name="type" value="<?=empty($getC->id_fabric_cost)?'add':'edit'?>">
                  <input type="text" class="form-control input required w50" name="id_fabric_cost" id="id_fabric_cost" value="<?= $getC->id_fabric_cost; empty($getC->id_fabric_cost)?'':$getC->id_fabric_cost?>" readonly>
                  <label class="label label-danger id_fabric_cost hideIt">Code Can't be empty!</label>
                </label>
              </td>
            </tr>

          ...
          <table id="my-grid1" class="table table-striped table-bordered table-hover table-condensed" width="100%">
            <tbody>
              ...
              <tr id="my-grid-tr-id_supplier">
                ...
                <td class="text-left">
                  <input type="hidden" name="type" id="type_input" value="<?= empty($getC->id_supplier) ? 'add' : 'edit' ?>">
                  <input type="text" class="form-control input required w20" name="id_supplier" id="id_supplier" value="<?= empty($getC->id_supplier) ? '' : $getC->id_supplier ?>">
          ...
          <table id="my-grid2" class="table table-striped table-bordered table-hover table-condensed" width="100%">
            <tbody>
              ...
              <tr id="my-grid-tr-nm_supplier_factory">
                <td class="text-left vMid" width="25%">Supplier Factory Name</td>
                <td class="text-left">
                  <input type="text" name="nm_supplier_factory" id="nm_supplier_factory" placeholder="Factory Name" autocomplete="off" class="form-control w60 ucfirst" value="<?= empty($getC->nm_supplier_factory) ? '' : $getC->nm_supplier_factory ?>">
                  <small class="text-red nm_supplier_factory hideIt">Factory Name Can't be empty!</small>
                </td>
              </tr>

              <tr id="my-grid-tr-id_country_factory">
                <td class="text-left vMid">Country</td>
                <td class="text-left">
                  <select class="form-control select2 " name="id_country_factory" id="id_country_factory"></select>
              ...
              <tr id="my-grid-tr-id_prov_factory">
                ...
                <td class="text-left">
                  <select class="form-control select2 w50" name="id_prov_factory" id="id_prov_factory">
                  </select>
              ...
              <tr id="my-grid-tr-city_factory">
                <td class="text-left vMid">City</td>
                <td class="text-left">
                  <select class="form-control select2 w50" name="city_factory" id="city_factory"></select>
                  <small class="text-red city_factory hideIt">City Can't be empty!</small>
                </td>
              </tr>

              <tr id="my-grid-tr-address_factory">
                <td class="text-left vMid">Address</td>
                <td class="text-left">
                  <label class="label_view">
                    <?= ($getC) ? $getC->address_factory : '-' ?>
                  </label>
                  <textarea name="address_factory" id="address_factory" class="form-control  w60" placeholder="Address"><?= empty($getC->address_factory) ? '' : $getC->address_factory ?></textarea>
                  <small class="text-red address_factory hideIt">Address Can't be empty!</small>
                </td>
              </tr>

              <tr id="my-grid-tr-zip_code_factory">
                <td class="text-left vMid">ZIP Code</td>
                <td class="text-left">
                  <?php
                  echo form_input(array('type' => 'text', 'id' => 'zip_code_factory', 'name' => 'zip_code_factory', 'class' => 'form-control w30', 'placeholder' => 'ZIP Code', 'autocomplete' => 'off', 'value' => empty($getC->zip_code_factory) ? '' : $getC->zip_code_factory))
                  ?>
              ...
              <tr id="my-grid-tr-telephone_factory_1">
                <td class="text-left vMid">Telephone (Factory)</td>
                <td class="text-left">
                  <?php
                  $tlp = '';
                  ...
                  echo form_input(array('type' => 'text', 'id' => 'telephone_factory_1_1', 'name' => 'telephone_factory_1[]', 'class' => 'form-control w15 numberOnly', 'placeholder' => 'Code', 'autocomplete' => 'off', 'maxlength' => '4', 'value' => empty($tlp[0]) ? '' : $tlp[0]));
                  echo " - ";
                  echo form_input(array('type' => 'text', 'id' => 'telephone_factory_1_2', 'name' => 'telephone_factory_1[]', 'class' => 'form-control w30 numberOnly', 'placeholder' => 'Number', 'autocomplete' => 'off', 'maxlength' => '9', 'value' => empty($tlp[1]) ? '' : $tlp[1]));
                  ?>
          ...
          <table id="my-grid3" class="table table-striped table-bordered table-hover table-condensed" width="100%">
            <tbody>
              ...
              <tr id="my-grid-tr-nm_supplier_excompany">
                <td class="text-left vMid" width="25%">Export Company Name</td>
                <td class="text-left">
                  <input type="text" name="nm_supplier_excompany" id="nm_supplier_excompany" placeholder="Export Company Name" autocomplete="off" class="form-control w60 ucfirst" value="<?= empty($getC->nm_supplier_excompany) ? '' : $getC->nm_supplier_excompany ?>">
              ...
              <tr id="my-grid-tr-id_country_excompany">
                <td class="text-left vMid">Country</td>
                <td class="text-left">
                  <select class="form-control select2 " name="id_country_excompany" id="id_country_excompany"></select>
              ...
              <tr id="my-grid-tr-id_prov_excompany">
                <td class="text-left vMid">Province</td>
                <td class="text-left">
                  <select class="form-control select2 w50" name="id_prov_excompany" id="id_prov_excompany">
                  </select>
              ...
              <tr id="my-grid-tr-id_city_excompany">
                <td class="text-left vMid">City</td>
                <td class="text-left">
                  <select class="form-control select2 w50" name="id_city_excompany" id="id_city_excompany"></select>
              ...
              <tr id="my-grid-tr-address_excompany">
                <td class="text-left vMid">Address</td>
                <td class="text-left">
                  <textarea name="address_excompany" id="address_excompany" class="form-control  w60" placeholder="Address"><?= empty($getC->address_excompany) ? '' : $getC->address_excompany ?></textarea>
              ...
              <tr id="my-grid-tr-zip_code_excompany">
                ...
                <td class="text-left">
                  <?php
                  echo form_input(array('type' => 'text', 'id' => 'zip_code_excompany', 'name' => 'zip_code_excompany', 'class' => 'form-control w30', 'placeholder' => 'ZIP Code', 'autocomplete' => 'off', 'value' => empty($getC->zip_code_excompany) ? '' : $getC->zip_code_excompany))
                  ?>
              ...
              <tr id="my-grid-tr-telephone_excompany_1">
                ...
                <td class="text-left">
                  ...
                  echo form_input(array('type' => 'text', 'id' => 'telephone_excompany_1_1', 'name' => 'telephone_excompany_1[]', 'class' => 'form-control w15 numberOnly', 'placeholder' => 'Code', 'autocomplete' => 'off', 'maxlength' => '4', 'value' => empty($tlp[0]) ? '' : $tlp[0]));
                  echo " - ";
                  echo form_input(array('type' => 'text', 'id' => 'telephone_excompany_1_2', 'name' => 'telephone_excompany_1[]', 'class' => 'form-control w30 numberOnly', 'placeholder' => 'Number', 'autocomplete' => 'off', 'maxlength' => '9', 'value' => empty($tlp[1]) ? '' : $tlp[1]));
                  ?>
          ...
          <table id="my-grid2" class="table table-striped table-bordered table-hover table-condensed" width="100%">
            ...
            <tbody>
              ...
              <tr id="my-grid-tr-id_business">
                ...
                <td class="text-left">
                  <select class="form-control select2 w50" name="id_business" id="id_business"></select>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('blur', '#nm_supplier__office', function(e) {

...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_sewing');
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>EDIT SEWING PRICE</b>");
      $("#view").load(siteurl+active_controller+'/modal_Process/Sewing/edit/'+id);
      $("#ModalView").modal();
		});
    ...
    $(document).on('click', '.detail', function(e){
      var id = $(this).data('id_sewing');
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>DETAIL SEWING PRICE</b>");
      $("#view").load(siteurl+active_controller+'modal_Process/Sewing/view/'+id);
      $("#ModalView").modal();
		});
//--------------------------------------------------------------------------------------------
    ...
    jQuery(document).on('click', '#saveSewing', function(){
      ...
      // console.log(valid);
      if (valid) {
        var formdata = new FormData(document.getElementById("form-sewing"));//$("#form-supplier").serialize();
        // console.log(formdata);
        $.ajax({
          url: siteurl+active_controller+"saveDataSewing",
          dataType : "json",
          type: 'POST',
          data: formdata,
          processData:false,
  ...
  function add_data(){
    $(".modal-dialog").css('width','60%');
    $("#head_title").html("<b>Add Sewing Price</b>");
    $("#view").load(siteurl+active_controller+'/modal_Process/Sewing/add/');
    $("#ModalView").modal();
  }

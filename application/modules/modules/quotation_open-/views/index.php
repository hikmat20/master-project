<?php
    $ENABLE_ADD     = has_permission('Quotation_open.Add');
    $ENABLE_MANAGE  = has_permission('Quotation_open.Manage');
    $ENABLE_VIEW    = has_permission('Quotation_open.View');
    $ENABLE_DELETE  = has_permission('Quotation_open.Delete');
?>

<?php
    $ENABLE_ADD     = has_permission('Sewing_cost.Add');
    $ENABLE_MANAGE  = has_permission('Sewing_cost.Manage');
    $ENABLE_VIEW    = has_permission('Sewing_cost.View');
    $ENABLE_DELETE  = has_permission('Sewing_cost.Delete');
?>
...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        <div class="tab-pane active" id="sewing_cost">
...
//--------------------------------------------------------------------------------------------
    ...
    $(document).on('click', '.edit', function(e){
      var id = $(this).data('id_sewing_cost');
      $(".modal-dialog").css('width','60%');
      $("#head_title").html("<b>EDIT FOH COST</b>");
      $("#view").load(siteurl+active_controller+'/modal_Process/sewing_cost/edit/'+id);
      $("#ModalView").modal();
		});
    ...
    $(document).on('click', '.detail', function(e){
      ...
      $("#view").load(siteurl+active_controller+'modal_Process/sewing_cost/view/'+id);
      $("#ModalView").modal();
		});

    //DELETE
    $(document).on('click', '.delete', function(e){
      var id_sewing_cost = $(this).data('id_sewing_cost');
      swal({
        title: "Are you sure?",
      ...
      function(isConfirm) {
        if (isConfirm) {
          $.ajax({
            ...
            dataType : "json",
            type: 'POST',
            data: {id_sewing_cost:id_sewing_cost},
  ...
  function add_data(){
    $(".modal-dialog").css('width','60%');
    $("#head_title").html("<b>Add Sewing Cost</b>");
    $("#view").load(siteurl+active_controller+'/modal_Process/sewing_cost/add/');
    $("#ModalView").modal();
  }

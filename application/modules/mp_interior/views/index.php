<?php
    $ENABLE_ADD     = has_permission('Mp_interior.Add');
    $ENABLE_MANAGE  = has_permission('Mp_interior.Manage');
    $ENABLE_VIEW    = has_permission('Mp_interior.View');
    $ENABLE_DELETE  = has_permission('Mp_interior.Delete');
?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    ...
    $(document).on('click', '.delete', function(e){
      var id_interior = $(this).data('id_interior');
      swal({
        title: "Are you sure?",
    ...
    jQuery(document).on('click', '#addPatternNameSave', function(){
      ...
      $.ajax({
        url: siteurl+"master_interior/savePatternName",
        dataType : "json",
        type: 'POST',
        data: formdata,
        processData:false,
    ...
    $(document).on('click', '#selBrand', function(e){
      ...
      var id_sup = $(this).data('id_interior');
      //console.log(id_sup);
    ...
    $(document).on('click', '#addBrandSave', function(e){
      ...
      $.ajax({
        url: siteurl+"master_interior/saveBrand",
        dataType : "json",
        type: 'POST',
        data: formdata,
        success: function(result){
    ...
    $(document).on('click', '#addPatternName', function(e){
      ...
      $("#view2").load(siteurl+'/master_interior/modal_Process/PatternName/add/');
      $("#ModalView2").modal();
    });
  ...
  function DataTables(set=null){
    ...
    var dataTable3 = $('#table_interior_type').DataTable({
      "serverSide": true,
      "stateSave" : true,
      "bAutoWidth": true,
      "destroy": true,

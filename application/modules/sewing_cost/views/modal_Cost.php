...
if (!empty($this->uri->segment(3))) {
  ...
  $getC = $this->db->get_where('sewing_cost',array('id_sewing_cost'=>$id))->row();
        ...
        <table id="my-grid3" class="table table-striped table-bordered table-hover table-condensed" width="100%">
          <tbody>
            <tr style='background-color: #175477 !important; color: white; font-size: 15px !important;'>
              <th class="text-center" colspan='3'>DETAIL SEWING COST</th>
            </tr>
            <tr id="my-grid-tr-id_sewing_cost">
              <td class="text-left vMid" width="20%">Code <span class='text-red'>*</span></b></td>
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$getC->id_sewing_cost:'-'?>
                </label>
                <label class="label_input">
                  <input type="hidden" name="type" value="<?=empty($getC->id_sewing_cost)?'add':'edit'?>">
                  <input type="text" class="form-control input required w50" name="id_sewing_cost" id="id_sewing_cost" value="<?= $getC->id_sewing_cost; empty($getC->id_sewing_cost)?'':$getC->id_sewing_cost?>" readonly>
                  <label class="label label-danger id_sewing_cost hideIt">Code Can't be empty!</label>
                </label>
              </td>
            </tr>
                ...
                <label class="label_input">
					...
					<div class="input-group">
					 <span class="input-group-addon" id="basic-addon1">Rp. </span>
					  <?= form_input(array('type'=>'text','id'=>'rate','name'=>'rate','class'=>'form-control required text-right numberOnly nominal w50','placeholder'=>'0','autocomplete'=>'off','value'=>empty($getC->rate)?'':number_format($getC->rate)))?>
					 <span class="input-group-addon" id="basic-addon2">.00</span>
					 </div>
					<div>
					  <label class="label label-danger rate hideIt">Rate Can't be empty!</label>
                </label>
              </td>
            </tr>

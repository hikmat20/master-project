<?php
    $ENABLE_ADD     = has_permission('Master_uom.Add');
    $ENABLE_MANAGE  = has_permission('Master_uom.Manage');
    $ENABLE_VIEW    = has_permission('Master_uom.View');
    $ENABLE_DELETE  = has_permission('Master_uom.Delete');
?>
<style type="text/css">
thead input {
	width: 100%;
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $(document).on('click', '.delete', function(e){
      ...
      $.ajax({
        url: siteurl+active_controller+"deleteUOM/"+formdata,
        dataType : "json",
        type: 'POST',
        data: formdata,
    ...
    $(document).on('click', '#selUOM', function(e){
			selUOM();
		});

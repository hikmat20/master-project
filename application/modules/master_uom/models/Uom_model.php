 ...
 *
 * This is model class for table "master_uom"
 */
...
class Uom_model extends BF_Model
{
     ...
     */
    protected $table_name = 'master_uom';
    protected $key        = 'id_uom';
    ...
    function generate_id() {
      $query = $this->db->query("SELECT MAX(id_uom) as max_id FROM master_uom");
      $row = $query->row_array();
      $max_id = $row['max_id'];

<?php
    $ENABLE_ADD     = has_permission('Mp_patterntype.Add');
    $ENABLE_MANAGE  = has_permission('Mp_patterntype.Manage');
    $ENABLE_VIEW    = has_permission('Mp_patterntype.View');
    $ENABLE_DELETE  = has_permission('Mp_patterntype.Delete');
?>
...
<div class="nav-tabs-custom">
    <ul class="nav nav-tabs">
        <li class="active"><a href="#Pattern_type" data-toggle="tab" aria-expanded="true" >Pattern Type</a></li>
        <li class=""><a href="#Customer_category" data-toggle="tab" aria-expanded="false" >Master Category Customer</a></li>
    </ul>

    <div class="tab-content">
        <div class="tab-pane active" id="Pattern_type">

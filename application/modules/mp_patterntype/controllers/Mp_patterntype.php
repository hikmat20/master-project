...
class Mp_patterntype extends Admin_Controller
{
    //Permission
    protected $viewPermission = 'Mp_patterntype.View';
    protected $addPermission  = 'Mp_patterntype.Add';
    protected $managePermission = 'Mp_patterntype.Manage';
    protected $deletePermission = 'Mp_patterntype.Delete';
    ...
    public function __construct()
    {
        ...
        $this->load->model(array('Mp_patterntype/Mp_patterntype_model',
    ...
    public function index()
    {
        ...
        $this->template->title('Pattern Type');
    ...
    public function getDataJSON(){
          ...
          $requestData['activation'],
            ...
            $nestedData[]	= "<div style='text-align:center'>
              ...
              <!--<a class='btn btn-sm btn-primary detail' href='javascript:void(0)' title='Detail' data-id_pattern_type='".$row['id_pattern_type']."' style='width:30px; display:inline-block'>
                <span class='glyphicon glyphicon-list'></span>
              </a>-->
              <a class='btn btn-sm btn-success edit' href='javascript:void(0)' title='Edit' data-id_pattern_type='".$row['id_pattern_type']."' style='width:30px; display:inline-block'>
                <span class='glyphicon glyphicon-edit'></span>
              </a>
              <a class='btn btn-sm btn-danger delete' href='javascript:void(0)' title='Delete' data-id_pattern_type = '".$row['id_pattern_type']."'  style='width:30px; display:inline-block'>
    ...
    public function deleteData(){
      $id_pattern_type				= $this->input->post('id_pattern_type');
      $this->db->trans_begin();
      $getCat   = $this->db->where('id_pattern_type',$id_pattern_type)->update('master_pattern_type', array('activation'=>'inactive','id_pattern_type'=>'Del-'.$id_pattern_type));
      ...
      if($this->db->trans_status() === FALSE){
        ...
        $keterangan = 'FAILED, Delete Customer Data '.$id_pattern_type;
        $status = 0;
        ...
        $keterangan = 'SUCCESS, Delete Customer Data '.$id_pattern_type;
        $status = 1;
        $nm_hak_akses = $this->addPermission;
        $kode_universal = $this->auth->user_id();
        $jumlah = 1;

          ...
          <tbody>
            ...
            <tr id="my-grid-tr-upload_dl">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <select class="form-control required select2" data-width="150" name="shipment" id="shipment" style="width:40%">
                    <option value="">None</option>
                    <option value="Yes" <?=(!empty($getC) && $getC->shipment == 'Yes')?'selected':''?> >Yes</option>
                    <option value="No" <?=(!empty($getC) && $getC->shipment == 'No')?'selected':''?> >No</option>
                  </select>
                  <label class="label label-danger shipment hideIt">Upload Digital Library Can't be empty!</label>
            ...
            <tr id="my-grid-tr-usage">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <select class="form-control required select2" data-width="150" name="usage" id="usage" style="width:40%">
                    <option value="">None</option>
                    <option value="Drapery (curtain)" <?=(!empty($getC) && $getC->usage == 'Drapery (curtain)')?'selected':''?> >Drapery (curtain)</option>
                    <option value="Upholstery (furniture fabrics)" <?=(!empty($getC) && $getC->usage == 'Upholstery (furniture fabrics)')?'selected':''?> >Upholstery (furniture fabrics)</option>
                    <option value="Dual-mix use" <?=(!empty($getC) && $getC->usage == 'Dual-mix use')?'selected':''?> >Dual-mix use</option>
                  </select>
            ...
            <tr id="my-grid-tr-furniture_application">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <select class="form-control required select2" data-width="150" name="furniture_application" id="furniture_application" style="width:40%">
                    <option value="">None</option>
            ...
            <tr id="my-grid-tr-curtain_application">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <select class="form-control select2" data-width="150" name="curtain_application" id="curtain_application" style="width:40%">
                    <option value="">None</option>
                    <option value="Indoor" <?=(!empty($getC) && $getC->curtain_application == 'Indoor')?'selected':''?> >Indoor</option>
                    <option value="Outdoor" <?=(!empty($getC) && $getC->curtain_application == 'Indoor')?'selected':''?> >Outdoor</option>
                  </select>
            ...
            <tr id="my-grid-tr-id_pattern_type">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$name_pattern_type->name_pattern_type:'-'?>
                </label>
                <div class="label_input form-inline">
                  <select class="form-control input-sm required select2" data-width="150" name="id_pattern_type" id="id_pattern_type">
                  </select>
                  <a id="addPatternType" class="btn btn-sm btn-primary" style="display:inline-block"><i class="fa fa-plus">&nbsp;</i></a>
            ...
            <tr id="my-grid-tr-id_pattern_name">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$name_pattern_name->name_pattern_name:'-'?>
                </label>
                <div class="label_input form-inline">
                  <select class="form-control input-sm required select2 id_needed" data-width="150" name="id_pattern_name" id="id_pattern_name">
                  </select>
                  <a id="addPatternName" class="btn btn-sm btn-primary" style="display:inline-block"><i class="fa fa-plus">&nbsp;</i></a>
            ...
            <tr id="my-grid-tr-id_characteristic">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$name_characteristic->name_characteristic:'-'?>
                </label>
                <div class="label_input">
                  <select class="form-control input-sm required select2" data-width="150" name="id_characteristic" id="id_characteristic">
                  </select>
            ...
            <tr id="my-grid-tr-id_brand">
              ...
              <td class="text-left">
                ...
                <div class="label_input form-inline">
                  <select class="form-control select2" data-width="150" name="id_brand" id="id_brand" style="margin-right:-18px">
            ...
            <tr id="my-grid-tr-id_collection">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$name_collection->name_collection:'-'?>
                </label>
                <div class="label_input form-inline">
                  <select class="form-control select2 id_collection" data-width="150" name="id_collection" id="id_collection" style="margin-right:-18px">
                  </select>
                  <a id="addCollection" class="btn btn-sm btn-primary" style="display:inline-block"><i class="fa fa-plus">&nbsp;</i></a>
            ...
            <tr id="my-grid-tr-id_class">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$name_class->name_class:'-'?>
                </label>
                <div class="label_input form-inline">
                  <select class="form-control select2" data-width="150" name="id_class" id="id_class" style="margin-right:-18px">
                  </select>
                  <a id="addClass" class="btn btn-sm btn-primary" style="display:inline-block"><i class="fa fa-plus">&nbsp;</i></a>
            ...
            <tr id="my-grid-tr-original_id_product">
              <td class="text-left vMid">Original Code <span class='text-red'>*</span></b></td>
              <td class="text-left">
                <label class="label_view">
                  <?=$getC->original_id_product?>
                </label>
                <div class="label_input">
                  <input type="text" class="form-control input input-sm required w50" name="original_id_product" id="original_id_product" value="<?=empty($getC->original_id_product)?'':$getC->original_id_product?>">
        ...
        <table id="my-grid2" class="table table-striped table-bordered table-hover table-condensed" width="100%">
          ...
          <tbody>
            ...
            <tr id="my-grid-tr-pricelist">
              <td class="text-left vMid">Price List</td>
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$getC->pricelist:'-'?>
                </label>
                <div class="label_input">
                  <div class="input-group select2-bootstrap-append">
                    <div class="input-group-btn">
                      <select class="form-control input select2 w20" name="pricelist_curs" id="pricelist_curs">
                      </select>
                    </div>
                    <input type="text" class="form-control input w50 numberOnly" name="pricelist" id="pricelist" style="display:inline-block" value="<?=empty($getC->pricelist)?'':$getC->pricelist?>">
                  </div>
            ...
            <tr id="my-grid-tr-moq">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <input type="text" class="form-control input input-sm w50" name="moq" id="moq" value="<?=empty($getC->moq)?'':$getC->moq?>" multiple>
            ...
            <tr id="my-grid-tr-id_country">
              ...
              <td class="text-left">
                ...
                <div class="label_input">
                  <select class="form-control input-sm select2" data-width="150" name="id_country" id="id_country">
                  </select>
            ...
            <tr id="my-grid-tr-similar_name">
              ...
              <td class="text-left">
                <label class="label_view">
                  <?=($getC)?$getC->similar_name:'-'?>
                </label>
                <div class="label_input">
                  <select class="form-control select2 required" name="similar_name" id="similar_name" style="width:250%;display:block" multiple>
                  </select>
